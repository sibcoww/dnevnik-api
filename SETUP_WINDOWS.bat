@echo off
REM Setup Instructions for Windows Users
...
echo.
echo ╔════════════════════════════════════════════════════════╗
echo ║  Dnevnik API - Setup Instructions (Windows)           ║
echo ╚════════════════════════════════════════════════════════╝
echo.
...
echo    createdb -U postgres dnevnik_db
...
echo    ^> exec(open('create_test_data.py').read())
echo.
